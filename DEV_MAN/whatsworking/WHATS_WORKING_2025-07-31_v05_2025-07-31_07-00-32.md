...
**Generated:** 2025-07-31 07:00:32
**Analyzed:** 44 Python files
**Total Lines of Code:** 5,848
...
graph TB
    subgraph "🎯 Pete Codebase Architecture"
        ...
        subgraph "⚙️ Backend Utils (6 files)"
            ...
            node_20["whatsworking.py<br/>📄 Backend<br/>📊 662 LOC"]
        end
        subgraph "🚪 🚪 Entry Points (2 files)"
            node_21["cli.py<br/>🚪 CLI<br/>📊 63 LOC"]
            node_22["config.py<br/>⚙️ Utility<br/>📊 7 LOC"]
        end
        subgraph "🎨 🎨 Frontend (4 files)"
            node_23["__init__.py<br/>📄 Frontend<br/>📊 2 LOC"]
            node_24["_deprecated_gui_mapping_tool.py<br/>🗺️ Frontend<br/>📊 1084 LOC"]
            node_25["constants.py<br/>📄 Frontend<br/>📊 27 LOC"]
            node_26["main_window.py<br/>🖼️ Frontend<br/>📊 214 LOC"]
        end
        subgraph "🧩 Components (8 files)"
            node_27["__init__.py<br/>📄 Frontend<br/>📊 25 LOC"]
            node_28["base_component.py<br/>📦 Frontend<br/>📊 51 LOC"]
            node_29["data_prep_editor.py<br/>📄 Frontend<br/>📊 593 LOC"]
            node_30["file_selector.py<br/>📄 Frontend<br/>📊 185 LOC"]
            node_31["mapping_table_widget.py<br/>🗺️ Frontend<br/>📊 99 LOC"]
            node_32["mapping_ui.py<br/>🗺️ Frontend<br/>📊 274 LOC"]
            node_33["standardized_preview_ui.py<br/>📄 Frontend<br/>📊 151 LOC"]
            node_34["startup_menu.py<br/>📄 Frontend<br/>📊 55 LOC"]
        end
        subgraph "🔧 Dialogs (5 files)"
            node_35["__init__.py<br/>📄 Frontend<br/>📊 19 LOC"]
            node_36["concatenation_dialog.py<br/>💬 Frontend<br/>📊 106 LOC"]
            node_37["rename_column_dialog.py<br/>💬 Frontend<br/>📊 73 LOC"]
            node_38["rule_mapping_dialog.py<br/>🗺️ Frontend<br/>📊 160 LOC"]
            node_39["settings_dialog.py<br/>⚙️ Frontend<br/>📊 113 LOC"]
        end
        subgraph "🛠️ Frontend Utils (1 files)"
            node_40["logo_utils.py<br/>🛠️ Frontend<br/>📊 21 LOC"]
        end
        subgraph "📁 Other (3 files)"
            node_41["hello.py<br/>📄 CLI<br/>📊 4 LOC"]
            node_42["run_gas_function.py<br/>📄 Utility<br/>📊 30 LOC"]
            node_43["update_gas.py<br/>📄 Utility<br/>📊 48 LOC"]
        end
    end
...
| `frontend/components/data_prep_editor.py` | 279 |
| `backend/utils/whatsworking.py` | 169 |
| `backend/utils/frontend_analyzer.py` | 103 |
| `frontend/components/mapping_ui.py` | 103 |
...
- **Local Imports:** base_component, data_prep_editor, file_selector, mapping_table_widget, mapping_ui, standardized_preview_ui, startup_menu
- **Special:** 📦 Init File
...
#### 📄 `frontend/components/data_prep_editor.py`
**Lines:** 593 | **Complexity:** 279
- **External Imports:** PyQt5, copy, pandas, typing
- **Local Imports:** frontend
- **Classes:** DataVersionManager, SmartConcatenationDialog, DataPrepEditor
- **Functions:** __init__, save_version, get_current_data, can_undo, can_redo (+25 more)
...
**Lines:** 214 | **Complexity:** 94
- **External Imports:** PyQt5, loguru, os, pandas, sys
- **Local Imports:** backend, frontend
- **Classes:** MainWindow
- **Functions:** main, __init__, _setup_ui, clear_layout, show_startup_menu (+12 more)
...
- `frontend/components/__init__.py` depends on: `frontend/components/standardized_preview_ui.py`, `frontend/components/base_component.py`, `frontend/components/startup_menu.py`, `frontend/components/mapping_ui.py`, `frontend/components/mapping_table_widget.py`, `frontend/components/file_selector.py`, `frontend/components/data_prep_editor.py`
- `frontend/dialogs/__init__.py` depends on: `frontend/dialogs/settings_dialog.py`, `frontend/dialogs/concatenation_dialog.py`, `frontend/dialogs/rename_column_dialog.py`, `frontend/dialogs/rule_mapping_dialog.py`
