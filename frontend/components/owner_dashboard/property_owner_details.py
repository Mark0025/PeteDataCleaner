...
from backend.utils.efficient_table_manager import format_currency, format_phone_quality, get_owner_name, get_owner_type, get_confidence_level
...
class PropertyOwnerDetails(QWidget):
    ...
    def create_owner_summary(self, layout):
        ...
        # Phone Quality
        quality_label = QLabel(f"<b>Phone Quality:</b> {format_phone_quality(self.owner.phone_quality_score, self.owner)}")
