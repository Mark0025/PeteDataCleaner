#!/usr/bin/env python3
"""
Small Pipeline Test - Test with subset of data
"""
...
def test_small_pipeline():
    ...
    try:
        ...
        df = df.head(1000)
        print(f"📊 Using subset: {len(df):,} rows for testing")
    ...
    try:
        ...
        excel_path = f"small_test_output_pete_ready_{timestamp}.xlsx"
        pete_df.to_excel(excel_path, index=False, engine='openpyxl')
        
        # Export to CSV
        csv_path = f"small_test_output_pete_ready_{timestamp}.csv"
...
if __name__ == "__main__":
    ...
    if success:
        print("\n🎉 SMALL TEST PASSED!")
        print("✅ Pipeline is working correctly with smaller dataset")
